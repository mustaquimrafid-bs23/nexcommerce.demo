...
export function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-transparent text-white flex flex-col justify-between pt-8 pb-12">
              ...
              <div className="pt-4 border-t border-white/10 space-y-3">
                ...
                <div className="grid grid-cols-1 gap-2.5 text-xs text-white/70">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span>Dedicated 24/7 Neural Style Concierge Access</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Clock size={14} className="text-accent-pink shrink-0" />
                    <span>Priority Express Continental Courier Dispatch</span>
                  </div>
                  <div className="flex items-center gap-2.5">
                    <Award size={14} className="text-accent-pink shrink-0" />
                    <span>Archival Pre-Access &amp; Complimentary Lifetime Care</span>
                  </div>
                </div>
              </div>
            </div>
