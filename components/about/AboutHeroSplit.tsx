...
export function AboutHeroSplit() {
  return (
    <section className="relative pt-12 pb-16 lg:pt-16 lg:pb-24 border-b border-white/10" id="aboutHeroSection" aria-label="Our Story and Heritage">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {/* Left Column: Editorial Headline, Philosophy & Section Navigation */}
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-accent-pink/10 border border-accent-pink/25 text-xs font-semibold uppercase tracking-widest text-accent-pink">
              <Sparkles size={13} />
              <span>Our Story &amp; Philosophy &middot; Founded 2022</span>
            </div>

            <h1 className="font-editorial text-4xl sm:text-5xl lg:text-6xl font-normal leading-[1.08] text-white">
              Timeless style, <span className="italic font-normal">crafted to endure.</span>
            </h1>

            <p className="text-sm sm:text-base text-white/70 leading-relaxed max-w-2xl font-light">
              We reject fast fashion and disposable trends in favour of timeless tailoring, noble raw materials, and unhurried craftsmanship. Every garment is carefully made to last for decades, growing softer and more personal with every wear.
            </p>

            {/* Quick Section Navigation Rail */}
            <div className="pt-2 flex flex-wrap items-center gap-2.5 text-xs font-medium text-white/60">
              ...
              <a href="#provenance" className="px-3.5 py-2 rounded-xl bg-white/[0.04] border border-white/10 hover:border-accent-cyan/40 hover:text-accent-cyan transition-colors">
                Standards
              </a>
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/15 bg-surface-card p-2 shadow-2xl group">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden">
                <img
                  ...
                  alt="nexCommerce Tailoring Workshop and European Craft"
