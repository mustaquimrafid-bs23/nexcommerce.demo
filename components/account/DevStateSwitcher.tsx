  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 bg-white/[0.03] border border-dashed border-white/15 rounded-xl px-4 py-2.5 mb-8 text-xs text-white/50">
      <div className="flex items-center gap-2 font-medium tracking-wide">
        ...
        <span className="uppercase text-[11px] font-semibold text-white/60">Developer State Switcher:</span>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          className="bg-obsidian-950 border border-white/20 rounded-lg px-3 py-1.5 text-xs text-white focus:outline-none focus:border-accent-cyan transition-colors cursor-pointer"
        >
