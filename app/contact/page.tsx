...
import { Sparkles, MessageSquare, ArrowLeft, Shield } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="space-y-4 max-w-3xl">
          ...
          <p className="text-sm sm:text-base text-white/70 leading-relaxed font-light">
            Whether inquiring about bespoke tailoring, private commission timepieces, order dispatch routing, or European statutory returns, our client advisory desk is at your service.
          </p>
        </div>

        {/* 1. Dedicated Service Channels */}
        <ServiceChannelsGrid />

        {/* 2. Interactive Ticket Dispatcher */}
        <TicketDispatcherCard />

        {/* 3. Physical Ateliers Directory */}
        <AteliersDirectory />

        {/* Privacy Note */}
        <p className="text-center text-xs text-white/40 flex items-center justify-center gap-2 pt-4">
          <Shield size={12} className="text-emerald-400" />
          <span>All inquiries are transmitted via encrypted European transport and resolved strictly by atelier staff.</span>
        </p>
      </div>
    </div>
  );
