...
export const MASTER_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    currency: 'EUR',
    description: 'Structured leather tote crafted from premium vegetable-tanned leather with durable canvas lining and a padded laptop pocket.',
    ...
    colors: [
      ...
      { name: 'Tuscan Leather', hex: '#78350F', img: '/assets/images/lifestyle/thumb_tote.jpg' },
    ...
    reasoning: 'Heavyweight vegetable-tanned Tuscan leather tote with structured silhouette, solid brass hardware, and a padded 16” laptop compartment.',
    whyExpanded: [
      { label: 'Structured Silhouette', desc: 'Premium vegetable-tanned leather holds its architectural shape elegantly for daily carry.' },
      { label: 'Dedicated Tech Sleeve', desc: 'Padded microfiber sleeve securely fits up to 16" laptops.' },
      { label: 'Bridle Leather Straps', desc: 'Solid brass hardware with hand-riveted full-grain leather straps.' },
    ],
    tags: ['tote', 'totes', 'bag', 'bags', 'canvas', 'leather', 'structured', 'accessories', 'laptop', 'travel', 'work', 'commute', 'black'],
  },
  {
    id: 'p8',
